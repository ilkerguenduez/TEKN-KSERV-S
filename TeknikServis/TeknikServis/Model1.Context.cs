...
namespace TeknikServis
{
    ...
    public partial class DBTEKNIKSERVISEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> enfazlacarııl()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("enfazlacarııl");
        }
    
        public virtual ObjectResult<calisansayisi_Result> calisansayisi()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<calisansayisi_Result>("calisansayisi");
        }
    
        public virtual ObjectResult<calisansayisiartan_Result> calisansayisiartan()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<calisansayisiartan_Result>("calisansayisiartan");
        }
    
        public virtual ObjectResult<calisansayisiazalan_Result> calisansayisiazalan()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<calisansayisiazalan_Result>("calisansayisiazalan");
        }
    }
}
