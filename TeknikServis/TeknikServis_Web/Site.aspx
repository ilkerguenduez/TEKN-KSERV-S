<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Site.aspx.cs" Inherits="TeknikServis_Web.Site" %>
...
<body>
    <div class="sidenav">
        <div class="row side_top">
            <div class="col-4 side_top_left">
                <img src="web/images/technical1.jpg" alt="news image" class="img-fluid navimg">
            </div>
    ...
    <div class="main" id="home">
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1><strong>En iyi ürün en uygun fiyatla kapınızda.</strong></h1>
                    <p class="banp mx-auto mt-3">Farklı kategorilerde farklı ürünler elinizin altında.  </p>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <img src="web/images/about123.jpg" class="img-fluid" alt="">
            <p class="iner mt-5">
        ...
        <div class="wthree_pvtits-services align-w3" id="services">
            <div class="container">
                <div class="wthree_pvt_title text-center">
                    ...
                    <p class="main_p mb-5  text-center mx-auto">Mağazamızdan almış olduğunuz ürünlerimi 2 yıl sürece garanti kapsamına girmektedir...</p>
                <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" style="background-color:red" href="WebForm1.Aspx" role="button">Arızalı Ürün Takibi</a>
                </div>
                <div class="wthree_pvtits-services-row row">
                    ...
                    <div class="col-lg-4 col-md-6 wthree_sgrid  py-sm-5 py-4">
                        ...
                        <h4 class="my-3">En İyi En Uygun </h4>
                    </div>
                    <div class="col-lg-4 col-md-6 wthree_sgrid  py-sm-5 py-4">
                        <span class="fa fa-camera p-sm-4 p-2"></span>
                        <h4 class="my-3">Hızlı Ve Güvenilir Teslimat</h4>
                    </div>
                    <div class="col-lg-4 col-md-6 wthree_sgrid   py-sm-5 py-4">
                        <span class="fa fa-bell-o p-sm-4 p-2"></span>
                        <h4 class="my-3">2 Yıl Arıza Durumunda Garanti</h4>
                    </div>
                    <div class="col-lg-4 col-md-6  wthree_sgrid  py-sm-5 py-4">
                        <span class="fa fa fa-smile-o p-sm-4 p-2"></span>
                        <h4 class="my-3">Güler Yüz Ve Memnuniyet</h4>
                    </div>
                    <div class="col-lg-4 col-md-6  wthree_sgrid   py-sm-5 py-4">
        ...
        <section class="wedo" id="contact">
            ...
            <p class="main_p mb-5  text-center mx-auto">Merak ettiğiniz her soru veya sorun da bize aşağıdan ulaşabilirsiniz.En kısa sürede birimlerimiz geri dönüş yapacaktır.</p>
            ...
            <div class="cpy-right text-center">
                ...
                <p>
                    © 2018 Teknik Servis ve Ürün Takip Sistemi | Tüm Hakları Saklıdır.
